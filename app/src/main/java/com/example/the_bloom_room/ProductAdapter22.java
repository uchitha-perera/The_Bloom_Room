...
public class ProductAdapter22 extends BaseAdapter {

    Context context;
    ArrayList<Product> products;

    public ProductAdapter22(Context context, ArrayList<Product> products) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View view1 = inflater.inflate(R.layout.custom_product_layout22,viewGroup, false);
